...
class HardhatNetworkProvider extends events_1.EventEmitter {
    ...
    async _sendWithLogging(method, params = []) {
        ...
        try {
            ...
            if (err instanceof solidity_errors_1.SolidityError) {
                ...
                this._log("");
                this._log("If you think this is a bug in Hardhat, please report it here: https://usehardhat.com/reportbug", true);
            }
            this._log("");
            throw err;
        }
    ...
    async _init() {
        ...
        this._common = common;
        this._node = node;
        this._ethModule = new eth_1.EthModule(common, node, this._throwOnTransactionFailures, this._throwOnCallFailures, this._loggingEnabled ? this._logger : undefined, this._experimentalHardhatNetworkMessageTraceHooks);
