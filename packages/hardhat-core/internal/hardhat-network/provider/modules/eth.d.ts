...
export declare class EthModule {
    ...
    constructor(_common: Common, _node: HardhatNode, _throwOnTransactionFailures: boolean, _throwOnCallFailures: boolean, _logger?: ModulesLogger | undefined, _experimentalHardhatNetworkMessageTraceHooks?: BoundExperimentalHardhatNetworkMessageTraceHook[]);
