import { HardhatConfig, ProjectPaths, UserHardhatConfig, UserProjectPaths } from "../../../types";
/**
 ...
 */
export declare function resolveConfig(userConfigPath: string, userConfig: UserHardhatConfig): HardhatConfig;
/**
 ...
 */
export declare function resolveProjectPaths(userConfigPath: string, userPaths?: UserProjectPaths): ProjectPaths;
