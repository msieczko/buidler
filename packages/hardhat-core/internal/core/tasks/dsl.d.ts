...
export declare class TasksDSL {
    readonly internalTask: {
        <ArgsT extends any>(name: string, description?: string | undefined, action?: ActionType<ArgsT> | undefined): TaskDefinition;
        <ArgsT_1 extends any>(name: string, action: ActionType<ArgsT_1>): TaskDefinition;
    };
